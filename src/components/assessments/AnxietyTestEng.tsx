...
const AnxietyTestEng = (props: AnxietyTestEngProps) => {
  ...
  const totalQuestions = GAD7_QUESTIONS_EN.length;
  ...
  const handleSubmit = () => {
    ...
    if (!allAnswered) {
      const firstUnanswered = findNextUnanswered(0, answers);
      if (firstUnanswered !== null) {
        alert("Jumping to the first unanswered question.");
        setDirection(firstUnanswered > currentQuestionIndex ? 1 : -1);
        setCurrentQuestionIndex(firstUnanswered);
      }
      return;
          ...
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              <Text
                ...
                textAlign="center"
              >
                {GAD7_QUESTIONS_EN[currentQuestionIndex]}
              </Text>
              <RadioGroup
              ...
              {totalScore === null ? (
                <VStack gap={4}>
                  ...
                  <Text fontSize="xl" fontWeight="bold" color="gray.800">
                    Ready to calculate your anxiety score.
                  </Text>
                  <Button
